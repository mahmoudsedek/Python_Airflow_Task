...
# Task 5 for creating Hive table
...
# Task 7 Sending Email
    ...
    sending_email_notification = EmailOperator(
        ...
        to="mahmoudsedek95@gmail.com",
        subject="forex_data_pipeline",
        html_content="""<h3>forex_data_pipeline completed successfully</h3>"""
    )
...
# Task 8 Slack
    ...
    sending_slack_notification = SlackWebhookOperator(
        ...
        webhook_token="T0219773SQM/B02197MU7BQ/SF0u6OtE4Hn2KhJ9Vu5nZBj9",
